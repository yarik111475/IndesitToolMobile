...
Evo1FaultParser::Evo1FaultParser()
{

}

void Evo1FaultParser::parseLastFault(const char lastFaultData)
{
...
void Evo1FaultParser::parseFaultsList(const QByteArray &faultsData)
{
    quint8 faultIndex=1;
...
void Evo1FaultParser::parseLastFaultFromEepData()
{
    parseLastFault(0x00);
}

void Evo1FaultParser::parseFailtsListFromEepData()
{
